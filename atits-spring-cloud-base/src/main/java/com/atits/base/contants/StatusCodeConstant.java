...
public enum  StatusCodeConstant {
     ...
     */
    _307(307L, "请求成功，使用原有的请求方式来通过新地址获取资源"),
    /**
     * 类似 301，但要求使用原有的请求方式来通过新地址获取资源。
     */
    _308(308L, "请求成功，使用原有的请求方式来通过新地址获取资源"),
    /**
     ...
     * 为将来的需要所保留的状态码
     */
    _402(402L, "为将来的需要所保留的状态码"),
    /**
     * 请求的资源不允许访问。比如说， 你使用普通用户的 Token 去请求管理员才能访问的资源。
     */
    _403(403L, "请求的资源不允许访问"),
    /**
     * 请求的内容不存在
     */
    _404(404L, "请求的内容不存在"),
     ...
     * 登录失败
     */
    _500004(500004L,"登录失败"),
    /**
     * Token过期
     */
    _500005(500005L,"Token过期"),
    /**
     * Token无效
     */
    _500006(500006L,"Token无效"),
    /**
     * 未携带tokenToken
     */
    _500007(500007L,"未携带tokenToken"),
    /**
     * 未授权
     */
    _500008(500008L,"未授权"),
    ...
    StatusCodeConstant(Long code,String message){
        this.code = code;
